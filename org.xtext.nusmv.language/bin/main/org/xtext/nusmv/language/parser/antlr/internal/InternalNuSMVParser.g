...
@after {
	...
	(
		...
		(
			...
			(
				(
					lv_op_2_0=GreaterThanSignGreaterThanSign
					{
...
@after {
	...
	(
		...
		(
			...
			(
				(
					lv_op_2_0=LessThanSignLessThanSign
					{
...
@after {
	...
	(
		...
		(
		    ...
		    |
		(
			enumLiteral_4=LessThanSignEqualsSign
			{
...
@after {
	...
	(
		enumLiteral_0=LessThanSignHyphenMinusGreaterThanSign
		{
