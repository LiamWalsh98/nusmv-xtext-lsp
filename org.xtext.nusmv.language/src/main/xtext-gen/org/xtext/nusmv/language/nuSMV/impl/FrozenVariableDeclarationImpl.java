 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.nusmv.language.nuSMV.impl.FrozenVariableDeclarationImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrozenVariableDeclarationImpl extends ModuleElementImpl implements FrozenVariableDeclaration
{
  ...
  {
    return NuSMVPackage.Literals.FROZEN_VARIABLE_DECLARATION;
  }
  ...
  public EList<VarBody> getVars()
  {
    if (vars == null)
    {
      vars = new EObjectContainmentEList<VarBody>(VarBody.class, this, NuSMVPackage.FROZEN_VARIABLE_DECLARATION__VARS);
    }
    return vars;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NuSMVPackage.FROZEN_VARIABLE_DECLARATION__VARS:
