 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.nusmv.language.nuSMV.impl.LTLExpressionImpl#getSimpleExpression <em>Simple Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LTLExpressionImpl extends MinimalEObjectImpl.Container implements LTLExpression
{
  ...
  {
    return NuSMVPackage.Literals.LTL_EXPRESSION;
  }
  ...
  public NotificationChain basicSetSimpleExpression(SimpleExpression newSimpleExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NuSMVPackage.LTL_EXPRESSION__SIMPLE_EXPRESSION, oldSimpleExpression, newSimpleExpression);
  ...
  public void setSimpleExpression(SimpleExpression newSimpleExpression)
  {
    if (newSimpleExpression != simpleExpression)
    {
      ...
      if (simpleExpression != null)
        msgs = ((InternalEObject)simpleExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NuSMVPackage.LTL_EXPRESSION__SIMPLE_EXPRESSION, null, msgs);
      if (newSimpleExpression != null)
        msgs = ((InternalEObject)newSimpleExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NuSMVPackage.LTL_EXPRESSION__SIMPLE_EXPRESSION, null, msgs);
      msgs = basicSetSimpleExpression(newSimpleExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NuSMVPackage.LTL_EXPRESSION__SIMPLE_EXPRESSION, newSimpleExpression, newSimpleExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NuSMVPackage.LTL_EXPRESSION__SIMPLE_EXPRESSION:
