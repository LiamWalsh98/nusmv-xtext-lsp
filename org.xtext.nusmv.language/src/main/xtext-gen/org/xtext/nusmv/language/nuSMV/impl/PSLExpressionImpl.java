 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.nusmv.language.nuSMV.impl.PSLExpressionImpl#getSimpleExpression <em>Simple Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PSLExpressionImpl extends MinimalEObjectImpl.Container implements PSLExpression
{
  ...
  {
    return NuSMVPackage.Literals.PSL_EXPRESSION;
  }
  ...
  public NotificationChain basicSetSimpleExpression(SimpleExpression newSimpleExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NuSMVPackage.PSL_EXPRESSION__SIMPLE_EXPRESSION, oldSimpleExpression, newSimpleExpression);
  ...
  public void setSimpleExpression(SimpleExpression newSimpleExpression)
  {
    if (newSimpleExpression != simpleExpression)
    {
      ...
      if (simpleExpression != null)
        msgs = ((InternalEObject)simpleExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NuSMVPackage.PSL_EXPRESSION__SIMPLE_EXPRESSION, null, msgs);
      if (newSimpleExpression != null)
        msgs = ((InternalEObject)newSimpleExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NuSMVPackage.PSL_EXPRESSION__SIMPLE_EXPRESSION, null, msgs);
      msgs = basicSetSimpleExpression(newSimpleExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NuSMVPackage.PSL_EXPRESSION__SIMPLE_EXPRESSION, newSimpleExpression, newSimpleExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NuSMVPackage.PSL_EXPRESSION__SIMPLE_EXPRESSION:
